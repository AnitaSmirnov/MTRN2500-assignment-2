...
void follow() {
	/*
	otherVehicles[0]->setX((otherVehicles[1]->getX() + otherVehicles[0]->getX()) / 2);
	otherVehicles[0]->setY((otherVehicles[1]->getY() + otherVehicles[0]->getY()) / 2);
	otherVehicles[0]->setZ((otherVehicles[1]->getZ() + otherVehicles[0]->getZ()) / 2);
